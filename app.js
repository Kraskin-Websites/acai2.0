...
function renderCategoriesNav() {
  ...
  pizzaChip.innerHTML = `<span class="emoji">🍕</span> Monte Seu Açaí `;
    ...
    <div class="checkout__body">
      ...
      <div class="checkout__section">
        ...
        <div id="deliveryFields">
          <p style="font-size: 12px; color: var(--accent); margin-bottom: 10px; font-weight: bold;">📍Porto Alegre </p>
          <div class="checkout__input-group">
            <label>Bairro *</label>
  ...
  try {
    ...
    const response = await fetch(`${PIX_SERVER_URL}/orders`, {
      ...
      body: JSON.stringify({
        ...
        cidade: deliveryType === 'delivery' ? 'Porto Alegre' : null,
